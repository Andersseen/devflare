    ...
    <volt-sidebar>
      ...
      <volt-sidebar-header>
        <a routerLink="/" class="flex items-center gap-2 overflow-hidden">
          <div
            class="w-8 h-8 shrink-0 bg-primary rounded-lg flex items-center justify-center"
          >
      ...
      <volt-sidebar-content>
        ...
        <volt-sidebar-group label="Tools">
          ...
          <volt-sidebar-item
            routerLink="/tools/svg-optimizer"
            label="SVG Optimizer"
          >
          ...
          <volt-sidebar-item
            routerLink="/tools/seo-simulator"
            label="SEO Simulator"
          >
          ...
          <volt-sidebar-item
            routerLink="/tools/og-generator"
            label="Social Card Designer"
          >
            <lucide-icon slot="icon" name="globe" class="w-5 h-5" />
          </volt-sidebar-item>

          <volt-sidebar-item
            routerLink="/tools/palette"
            label="Cinematic Palette"
          >
            <lucide-icon slot="icon" name="brush" class="w-5 h-5" />
          </volt-sidebar-item>

          <volt-sidebar-item
            routerLink="/tools/bg-remover"
