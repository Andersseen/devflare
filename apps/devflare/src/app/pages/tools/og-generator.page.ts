  ...
  template: `
    <div class="space-y-6">
      <div>
        ...
        <p class="text-muted-foreground mt-1">Create beautiful Open Graph images for your social media posts</p>
      </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          <volt-card>
            ...
            <volt-card-content class="space-y-4">
              ...
              <volt-textarea label="Description" [(value)]="description" [rows]="3" />
        ...
        <!-- Preview -->
        <div class="flex items-center justify-center p-4 bg-muted/30 rounded-xl border border-border overflow-hidden relative">
          ...
          <div class="origin-center transform scale-[0.35] sm:scale-[0.45] md:scale-[0.5] lg:scale-[0.55] transition-transform duration-300 shadow-2xl">
            <div
              #cardRef
            ...
            >
              ...
              <div class="flex items-center gap-6 relative z-10">
                ...
                <div class="ml-auto h-2 w-32 rounded-full" [style.background-color]="themeColor()"></div>
              </div>
            </div>
          </div>
        </div>
