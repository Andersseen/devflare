  ...
  template: `
    <div class="space-y-6 max-w-3xl mx-auto">
      <div>
        ...
        <p class="text-muted-foreground mt-1">Manage your profile and preferences</p>
      </div>

      <volt-tabs [(value)]="activeTab">
        <volt-tabs-list>
          <volt-tabs-trigger value="profile">Profile</volt-tabs-trigger>
          <volt-tabs-trigger value="integrations">Integrations</volt-tabs-trigger>
        </volt-tabs-list>
          ...
          <volt-card>
            ...
            <volt-card-content class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <volt-input label="Email Address" type="email" [(value)]="userEmail" [disabled]="true" />
              </div>
              ...
              <div class="flex justify-end">
                <volt-button variant="solid" (click)="saveProfile()" [disabled]="isSaving()">
                  @if (isSaving()) {
        ...
        <volt-tabs-content value="integrations">
          <div class="space-y-4">
            <volt-card>
              <volt-card-content class="flex items-center justify-between py-4">
                <div class="flex items-center gap-4">
                  <div class="w-10 h-10 rounded-md bg-orange-500/10 flex items-center justify-center text-orange-500">
                    <lucide-icon name="database" class="w-5 h-5" />
                  </div>
                  <div>
                    <h4 class="font-medium">Cloudflare R2</h4>
                    <p class="text-sm text-muted-foreground">Configure bucket and access credentials</p>
                  </div>
                </div>
            ...
            <volt-card>
              <volt-card-content class="flex items-center justify-between py-4 opacity-60">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">Connect your repositories</p>
                  </div>
                </div>
                <volt-button variant="ghost" size="sm" [disabled]="true">Coming Soon</volt-button>
              </volt-card-content>
            </volt-card>
          </div>
        </volt-tabs-content>
