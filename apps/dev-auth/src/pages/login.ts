  ...
  return renderLayout({
    ...
    body: `
      <and-card variant="elevated" padded
        ...
        <a href="/api/auth/sign-in/social?provider=github&callbackURL=/" style="text-decoration:none">
          <and-button variant="outline" full>
