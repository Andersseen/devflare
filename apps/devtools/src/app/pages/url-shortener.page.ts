...
import { UrlShortener, type HistoryItem } from '../tools/url-shortener.service';
    ...
    <div class="space-y-6 max-w-3xl mx-auto">
      <div>
        ...
        <p class="text-muted-foreground mt-1">
          Draft short aliases for long links, each with a QR code
        </p>
        <p class="text-sm text-muted-foreground mt-2">
          Aliases are kept in this browser only. DevTools has no redirect
          service, so a short link does not resolve anywhere yet.
        </p>
      </div>
